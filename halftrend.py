...
def fast_halftrend(candles, source, amplitude, channeldev, atr2):
    maxLowPrice =  np.zeros(source.shape[0])
    minHighPrice =  np.zeros(source.shape[0])
    highPrice =  np.zeros(source.shape[0])
    lowPrice =  np.zeros(source.shape[0])
    highma =  np.zeros(source.shape[0])
    lowma =  np.zeros(source.shape[0])
    dev =  np.zeros(source.shape[0])
    nextTrend =  np.zeros(source.shape[0])
    up =  np.zeros(source.shape[0])
    down =  np.zeros(source.shape[0])
    trend =  np.zeros(source.shape[0])
    atrHigh =  np.zeros(source.shape[0])
    atrLow =  np.zeros(source.shape[0])
    ht =  np.zeros(source.shape[0])
    test =  np.zeros(source.shape[0])
    sellSignal =  np.zeros(source.shape[0])
    buySignal =  np.zeros(source.shape[0])
    test1 =  np.zeros(source.shape[0])
